...
vpclib.create_or_update_Arecord(zone, 'edge0.example.com', inventory.nsxedge0_ip)
vpclib.create_or_update_Arecord(zone, 'edge1.example.com', inventory.nsxedge1_ip)
