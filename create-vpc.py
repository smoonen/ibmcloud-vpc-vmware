...
mgmt_subnet = vpclib.create_or_retrieve_subnet(vpc['id'], '192.168.2.0/24', zone1, 'smoonen-lon-mgmt1')
print("mgmt_subnet_id = '%s'" % mgmt_subnet['id'])
vmotion_subnet = vpclib.create_or_retrieve_subnet(vpc['id'], '192.168.3.0/24', zone1, 'smoonen-lon-vmotion1')
print("vmotion_subnet_id = '%s'" % vmotion_subnet['id'])
vsan_subnet = vpclib.create_or_retrieve_subnet(vpc['id'], '192.168.4.0/24', zone1, 'smoonen-lon-vsan1')
print("vsan_subnet_id = '%s'" % vsan_subnet['id'])
tep_subnet = vpclib.create_or_retrieve_subnet(vpc['id'], '192.168.5.0/24', zone1, 'smoonen-lon-tep1')
print("tep_subnet_id = '%s'" % tep_subnet['id'])
uplink_subnet = vpclib.create_or_retrieve_subnet(vpc['id'], '192.168.6.0/24', zone1, 'smoonen-lon-uplink1')
